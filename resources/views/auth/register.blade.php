<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <a href="{{ route('login') }}" class="inline-flex items-center px-2 py-2 ms-3 rounded-md font-semibold text-xs text-aurora-dark uppercase tracking-widest transition ease-in-out duration-150">
                {{ __('Return') }}
            </a>
